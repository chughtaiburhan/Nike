...
const Hero = () => {
  return (
    ...
    >
      <div className="relative xl:w-4/4 flex flex-col justify-center items-start w-full max-xl:padding-x ">
        <p className="text-xl text-coral-red">Our Summer Collection</p>
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82] font-boldt ">
